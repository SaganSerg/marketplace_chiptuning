<?php
class PageCustomerFacadeSentmailregistration extends PageCustomerFacade
{
    protected $pageName = '/sentmailregistration';
    ...
    private function composeHTML() 
    {
        ...
        <form class="main__form form" method="POST" action="/messagesentmailregistration">
